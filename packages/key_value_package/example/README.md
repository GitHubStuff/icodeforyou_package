...
- Find/Replace `key_value_demo` to name of the flutter name of the app (ex: `my_spiffy_app`)
- Find/Replace `Key Value Demo` to a label used for apps on mobile Platforms (ex:`My Spiffy Mobile App`)
- Find/Replace `Key Value Demo for Mac` to the name of your macOS app (ex: `My Spiffy macOS App`)
...
- Find/Replace `key_value_app` with bundle id (ex: `my_spiffy_app`) **[using the folder name is ideal]**
- Find/Replace `keyValueApp` for Apple bundles as iOS/MacOS do like '_'. **[ideal is folder name to lower-camel case (ex: `mySpiffyApp`)]**
